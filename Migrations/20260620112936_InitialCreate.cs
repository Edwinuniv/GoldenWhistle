    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MoodVotes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MoodVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MoodVotes_Matches_MatchId",
                        column: x => x.MatchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MoodVotes_MatchId",
                table: "MoodVotes",
                column: "MatchId");

            migrationBuilder.CreateIndex(
                name: "IX_MoodVotes_UserId",
                table: "MoodVotes",
                column: "UserId");
        }
